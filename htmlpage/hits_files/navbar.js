...
if(i==='titleAd'){$('#titleAd').css('background','url('+data[i].imageUrl+')');var tpl='<a title="'+data[i].headline+', #'+data[i].rank+' on IMDb Top 250" href="'
+data[i].clickThru+'?ref_=nv_mv_default_1" class="fallback"></a>'
+'<div class="overlay">'
+'<p>'
+'<a href="'+data[i].clickThru+'?ref_=nv_mv_default_2" id="titleAdClick">'
+'<strong>'+data[i].headline+'</strong> ('+data[i].titleYears
+')</a>'
+'<br />'
+'<a href="/chart/top?ref_=nv_mv_default_3" id="titleAdSecondaryClick">'
+'#<strong>'+data[i].rank+'</strong> on IMDb Top 250</a> &raquo;'
+'</p>'
+'</div>';}else{$('#nameAd').css('background','url('+data[i].imageUrl+')');var tpl='<a title="'+data[i].headline+', #'+data[i].rank+' on STARmeter" href="'
+data[i].clickThru+'?ref_=nv_cel_default_1" class="fallback"></a>'
+'<div class="overlay">'
+'<p>'
+'<a href="'+data[i].clickThru+'?ref_=nv_cel_default_2" id="nameAdClick">'
...
if(i==='titleAd'){$("#titleAdClick").one('click',function(){navbar_ads.impressionHandler(navbar_ads.clickEvents.title);});$("#titleAdSecondaryClick").one('click',function(){navbar_ads.impressionHandler(navbar_ads.secondaryClickEvents.title);});}else{$("#nameAdClick").one('click',function(){navbar_ads.impressionHandler(navbar_ads.clickEvents.name);});}}}
...
+'" height="209" width="140" title="'+titleTag+'" />');$a.append($img);$li.append($a);$navWatchlist.append($li);}
